        ...
        <div className="container flex flex-col justify-between">
          <div>
            ...
            <div className="py-10 px-5">
              <h1 className="text-2xl md:text-3xl lg:text-4xl lg:font-semibold text-slate-500 my-5">
                Module Description
              </h1>
                ...
                <div>
                  <form>
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-3">
                      <div className="mb-3">
                        ...
                        <input
                          type="text"
                          className={
                            "block w-full rounded-md border-0 py-1.5 pl-7 pr-20 text-gray-900 focus:outline-none ring-gray-300 ring-1 ring-inset placeholder:text-gray-400 sm:text-sm sm:leading-6"
                          }
                          id="title"
                          name="title"
                    ...
                    <div className="mb-3">
                      ...
                      <textarea
                        className={
                          "block w-full h-[100px] rounded-md border-0 py-1.5 pl-7 pr-20 text-gray-900 focus:outline-none ring-gray-300 ring-1 ring-inset placeholder:text-gray-400 sm:text-sm sm:leading-6"
                        }
                        name="description"
                        id="description"
                        ...
                        <div className="overflow-y-auto">
                          ...
                          <div className="w-3/4 my-3 ml-auto">
                            <div className="text-end">
                              <small className="text-gray-400 mb-3">You</small>
                            </div>
                            <div className="text-sm">
                              Lorem ipsum dolor sit amet, consectetur adipiscing
                              elit. Cras odio magna, tempor sed eleifend ut,
...
export default ProductionAuth(Attachments);
